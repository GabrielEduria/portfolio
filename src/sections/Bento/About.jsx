const About = () => {
    ...
    I use Next.js + React.Js to build clean, responsive, and user-focused web applications
    that help brands grow from  startups to e-commerce platform by designing
    and providing digital experiences.
    </p>
